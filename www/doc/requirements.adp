...
by <a href="mailto:kevin\@arsdigita.com">Kevin Scaldeferri</a><h3>I. Introduction</h3><p>This document describes the requirements for ACS File-Storage
...
large.</p><h3>II. Vision Statement</h3><p>The goal of a Web community is to facilitate the sharing of
...
versions.</p><p>Since information is only useful if you can find what you're
...
facilities.</p><h3>III. System/Application Overview</h3><p>The File-Storage application will consist primarily of a user
interface that allows individuals to manage their file-storage
folder(s) and to see other people's publicly accessible files.</p><h3>IV. Use Case and User Scenarios</h3><h4>Using File-Storage to Run a Project</h4><p>In the course of her job at Acme Publishing Company, <b>Ursula
...
- so she will need a full-text search feature.</p><p>For each project, Ursula makes a folder on the file-storage
...
deleting the files from the server.</p><h4>Administer File-Storage</h4><p>
...
accidentally revokes their own permission to access the file.</p><h3>V. Related Links</h3><ul>
<li><a href="design">Design Document</a></li><li><a href="index">System Overview Document</a></li>
</ul><h3>VI.A. Requirements: Data Model</h3><p><b>10 The Data Model</b></p><p>
<b>10.1</b> each file should have a unique identifier</p><p>
<b>10.2</b> each version of a file should have a unique
identifier</p><p>
<b>10.3</b> each file should have an associated owner</p><p>
<b>10.4</b> each version should have an associated owner</p><p>
...
requires InterMedia)</p><h3>VII. Revision History</h3><table cellpadding="2" cellspacing="2" width="90%" bgcolor="#EFEFEF">
<tr bgcolor="#E0E0E0">
...
</table><hr><address><a href="mailto:kevin\@arsdigita.com">kevin\@arsdigita.com</a></address>
